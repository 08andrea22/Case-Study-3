...
dist1=dist2=matrix(nrow=82, ncol=82)
for(j in 1:82){
  for(jj in 1:82){
    dist1[j,jj]=abs(tableaa$rank_ped_cardio[j]-tableaa$rank_ped_cardio[jj])
...
### Actually Sampling ###
stan_data = list(N=N, M = M, K = K, P = P, n=n, y = y, x = X, z = Z, g = g, dist1=dist1, dist2=dist2)
