...
f1 <- stan("Ciao.stan", data = stan_data, iter = 1000, chains = 1)
...
ggplot(Dunson)+
  geom_line(aes(x=t,y=Florida), color="red")+
  geom_vline(xintercept = E5[hosp1],color="red")+
  #geom_vline(xintercept = mode(Florida),color="orange")+
  geom_line(aes(x=t,y=Duke), color="green")+
  geom_vline(xintercept = E5[hosp2], color="green")+
